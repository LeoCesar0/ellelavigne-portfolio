        ...
        <div className="container">
          ...
          <div className={styles.aboutme}>
            <p className={styles.description}>
              ...
              <strong>
                design responsivo, UX/UI e programação front-end.
              </strong>{" "}
              Tenho um olhar atento aos detalhes e uma paixão por criar soluções
              visualmente atraentes que também ofereçam uma experiência de
              usuário excepcional.
            </p>
